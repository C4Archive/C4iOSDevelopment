...
-(id) init
{
    if((self = [super init]))
    {
        self.attributes = [[NSMutableDictionary alloc] initWithCapacity:0];
        
        //Default attributes
        [self.attributes setObject:[UIColor blackColor] forKey:@"foreground"];
        [self.attributes setObject:[UIFont systemFontOfSize:14.0f] forKey:@"font"];
    }
