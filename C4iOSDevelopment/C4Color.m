...
-(C4Color *)colorWithAlphaComponent:(CGFloat)alpha{
    C4Color *color = [C4Color colorWithUIColor:[cColor colorWithAlphaComponent:alpha]];
    return color;
}
...
-(id)initWithRed:(CGFloat)red green:(CGFloat)green blue:(CGFloat)blue alpha:(CGFloat)alpha {
    self = [super init];
    if(self) {
        cColor = [UIColor colorWithRed:red green:green blue:blue alpha:alpha];
    }
    return self;
}
...
-(const CGFloat *)components {
    const CGFloat *components = CGColorGetComponents([cColor CGColor]);
    return components;
}
