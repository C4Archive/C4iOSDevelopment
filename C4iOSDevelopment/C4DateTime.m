...
-(NSString *)monthName{
	return [[[[NSDateFormatter alloc] init] monthSymbols] objectAtIndex:[self month]-1];
}
...
-(NSString *)dayName{
	return [[[[NSDateFormatter alloc] init] weekdaySymbols] objectAtIndex:[self weekday]-1];
}
