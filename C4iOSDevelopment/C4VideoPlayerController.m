...
@interface C4VideoPlayerController()
...
@implementation C4VideoPlayerController
@synthesize player, playerItem, videoPlayerView;

-(void)loadMovieWithName:(NSString *)movieName {
    if(videoPlayerView == nil) {
        videoPlayerView = [[C4VideoPlayerView alloc] initWithFrame:CGRectMake(0, 0, 100, 100)];
        C4Log(@"alloc");
    }
